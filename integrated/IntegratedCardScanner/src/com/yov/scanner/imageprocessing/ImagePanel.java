...
public class ImagePanel extends /*JPanel,*/ Component implements MouseListener, MouseMotionListener, ActionListener{
	...
	private boolean isClicked, isDragged, isDragging, isFocused;
						...
						try {
							ImageIO
									.write(
											...
											"jpg",
											new File(
													"C:\\Users\\Yov\\Documents\\scannedImage0Cropped.jpg"));
						} catch (Exception ex) {
							ex.printStackTrace();
						}
