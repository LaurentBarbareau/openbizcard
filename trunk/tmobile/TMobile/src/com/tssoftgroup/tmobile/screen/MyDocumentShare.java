 ...
 * UiApplication.
 */
/*package*/ class DocumentShare extends MainScreen
{
...
public class MyDocumentShare extends FixMainScreen {
    private MainItem _mainMenuItem = new MainItem();
    private static MyDocumentShare instance;
    Img imgstock = Img.getInstance();
    public static MyDocumentShare getInstance(){
    	if(instance == null){
    		instance = new MyDocumentShare();
    	}
    	return instance;
    }
	private MyDocumentShare() {
        ...
        try{
            ...
            //select a file label
            LabelField label = new LabelField("Select a file to upload: " + Const.fileToUpload);
//            label.setBorder(BorderFactory.createSimpleBorder(edge,Border.STYLE_TRANSPARENT));
            add(label);
