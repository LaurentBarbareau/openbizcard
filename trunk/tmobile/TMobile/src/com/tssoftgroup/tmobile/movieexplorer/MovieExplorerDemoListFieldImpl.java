 ...
 */
/*package*/ final class MovieExplorerDemoListFieldImpl extends ListField implements ListFieldCallback
{
     ...
     */
    MovieExplorerDemoListFieldImpl()
    {
        setCallback(this);
    }
    ...
    public void drawListRow(ListField listField, Graphics graphics, int index, int y, int width) 
    {
        if (index < getSize()) 
        {
            MovieExplorerDemoFileHolder fileholder = (MovieExplorerDemoFileHolder)_elements.elementAt(index);
