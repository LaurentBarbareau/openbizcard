...
public class MultiPartFormOutputStream {
	...
	private String BOUNDARY_IMOBILE_626 = "FlPm4LpSXsE";
	...
	public void writeField(String name, boolean value)
			throws java.io.IOException {
		writeField(name, new Boolean(value).toString(), null);
	}
	...
	public void writeField(String name, double value)
			throws java.io.IOException {
		writeField(name, Double.toString(value), null);
	}
	...
	public void writeField(String name, float value) throws java.io.IOException {
		writeField(name, Float.toString(value), null);
	}
	...
	public void writeField(String name, long value) throws java.io.IOException {
		writeField(name, Long.toString(value), null);
	}
	...
	public void writeField(String name, int value) throws java.io.IOException {
		writeField(name, Integer.toString(value), null);
	}
	...
	public void writeField(String name, char value) throws java.io.IOException {
		writeField(name, new Character(value).toString(), null);
	}
	 ...
	 *             on input/output errors
	 */
	public void writeField(String name, String value, String enc)
			throws java.io.IOException {
		if (name == null) {
	...
	public void writeFile(String name, String mimeType, String fileName,
			byte[] data, String enc) throws java.io.IOException {
		if (data == null) {
	...
	public void writeStringEnc(String s, String enc) throws java.io.IOException {
		byte[] b;
		if (enc != null) {
			// b = s.getBytes(enc);
			b = CrieUtils.UTF8Encode(s);
		} else {
			b = s.getBytes();
		}
		out.write(b, 0, b.length);
